...
public class ClassToRecord : IFixture
{
    ...
    private const string Expected =
        ...
        """
            ...
            {
                public static TestNamespace.Car MapToCar(this TestNamespace.Truck source) =>
                   	new(Color: source.Color,Brand: source.Brand);
            }
            """;

    public SourceGenerationAssertion GetAssertion() => new(Source, [new("TruckToCar", Expected)]);
}
