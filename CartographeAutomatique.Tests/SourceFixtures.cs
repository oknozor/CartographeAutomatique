...
";
    ...
    public const string ListToArrays =
        //language=csharp
        @"
    namespace TestNamespace;

    [MapTo(typeof(FruitSalad))]
    class FruitBasket
    {
        List<string> Apples { get; set; }
        IImutableList<string> Pears { get; set; }
    }

    class FruitSalad
    {
        string[] Apples { get; set; }
        string[] Pears { get; set; }
    }";
